    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-16">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center gap-2 mb-4">
              <svg width="36" height="36" viewBox="0 0 40 40" fill="none">
                <path d="M20 4L34.5 12V28L20 36L5.5 28V12L20 4Z" fill="var(--accent)" opacity="0.15" />
              ...
              <div className="flex flex-col leading-none">
                ...
                <span className="text-xs tracking-widest uppercase" style={{ color: 'var(--text-muted)', fontFamily: 'var(--font-heading)' }}>
                  Digital
                </span>
              </div>
            </div>
            ...
            >
              We craft premium digital experiences that drive real business results.
              From modern web applications to high-converting landing pages, your vision is our mission.
            </p>
            {/* Social */}
        ...
        <div
          ...
          style={{ borderTop: '1px solid var(--section-divider)', color: 'var(--text-muted)' }}
        >
          <p>&copy; {new Date().getFullYear()} Orange Labs Digital. All rights reserved.</p>
