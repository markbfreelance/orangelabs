...
export default function Footer() {
  return (
    ...
    >
      ...
      {/* Grid lines */}
      <div className="ol-grid-lines" style={{ opacity: 0.5 }} />
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-16 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12">
          ...
          <div className="lg:col-span-2">
            ...
            >
              We craft premium digital experiences that drive real business
              results. From modern web applications to high-converting landing
              pages, your vision is our mission.
            </p>
            {/* Social */}
        ...
        >
          <p>
            ...
            <span className="font-bold">OrangeLabs</span> Digital. All rights
            reserved.
          </p>
